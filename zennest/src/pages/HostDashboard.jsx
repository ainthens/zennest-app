    ...
    <div className="min-h-screen bg-gray-50 flex h-screen overflow-hidden">
      ...
      `}>
        <div className="flex flex-col h-full">
          {/* Header */}
          <div className="p-6 border-b-2 border-gray-200 flex-shrink-0 bg-gradient-to-br from-emerald-600 to-emerald-700">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="lg:hidden text-white hover:text-emerald-100 transition-colors"
          ...
          {/* Navigation */}
          <nav className="flex-1 p-3 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
            <div className="space-y-4">
              {/* Create New Listing Button - Top Priority */}
              <div className="pb-3 border-b-2 border-gray-200">
                <button
                  onClick={() => handleNavigation('/host/listings/new')}
                  className="w-full flex items-center justify-center gap-2 px-3 py-2.5 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white rounded-lg hover:from-emerald-700 hover:to-emerald-800 transition-all duration-200 font-medium shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98] min-h-[40px] focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-1"
              ...
              <div className="bg-gray-50/50 rounded-lg p-2 border border-gray-100">
                <button
                  ...
                  className="w-full flex items-center justify-between px-2 pb-2 mb-2 group border-b border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-1 rounded"
                  aria-label={`${mainExpanded ? 'Collapse' : 'Expand'} main navigation section`}
                  aria-expanded={mainExpanded}
                >
                  <h3 className="text-[9px] font-medium text-gray-600 uppercase tracking-wider group-hover:text-emerald-700 transition-colors">
                    Main
                  </h3>
                  {mainExpanded ? (
                    <FaChevronUp className="text-[9px] text-gray-500 group-hover:text-emerald-700 transition-colors" />
                  ) : (
                    <FaChevronDown className="text-[9px] text-gray-500 group-hover:text-emerald-700 transition-colors" />
                  )}
                </button>
                <AnimatePresence>
                  {mainExpanded && (
                        ...
                        return (
                          <button
                            ...
                            className={`
                              ...
                              transition-all duration-200 min-h-[40px] relative group/item
                              ...
                              ${isActive
                                ...
                                : 'text-gray-700 hover:bg-gradient-to-r hover:from-emerald-50 hover:to-emerald-100/50 hover:text-emerald-800 hover:pl-4 hover:shadow-sm active:scale-[0.98]'
                              }
                            `}
                          >
                            {isActive && (
                            ...
                            <Icon className={`text-base flex-shrink-0 z-10 ${isActive ? 'text-white' : 'text-emerald-600 group-hover/item:text-emerald-700 group-hover/item:scale-110'} transition-all`} />
                            <span className={`text-xs z-10 font-medium`}>{item.label}</span>
                            {isActive && (
          ...
          {/* User Info & Logout */}
          <div className="p-4 border-t-2 border-gray-300 flex-shrink-0 bg-gradient-to-b from-white to-gray-50">
            <div className="mb-3 p-3 bg-gradient-to-br from-emerald-50 to-teal-50 rounded-xl border border-emerald-200 shadow-sm">
              <div className="flex items-center gap-2.5 mb-2.5">
                <div className="w-9 h-9 rounded-full bg-emerald-600 flex items-center justify-center text-white font-semibold shadow-md">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-2.5 text-red-600 hover:bg-red-50 rounded-lg transition-all font-semibold border-2 border-transparent hover:border-red-200 shadow-sm hover:shadow-md min-h-[44px]"
            >
      ...
      <AnimatePresence>
        {showLogoutConfirm && (
          <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 backdrop-blur-sm">
            ...
            >
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Confirm Log out</h3>
